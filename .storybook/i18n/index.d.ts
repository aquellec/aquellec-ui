...
export declare const dictionaries: Record<Locale, Dictionary>;
/** Storybook toolbar labels. */
export declare const localeLabels: Record<Locale, {
    title: string;
    flag: string;
}>;
 ...
 */
export declare function getDictionary(locale: unknown): Dictionary;
export declare const I18nContext: import("react").Context<{
    components: import("./en").ComponentLabels;
    docs: {
        sections: {
            pillars: {
                kicker: string;
...
export declare function useI18n(): Dictionary;
