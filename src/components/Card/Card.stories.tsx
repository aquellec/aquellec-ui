  ...
  render: (args) => {
    ...
    return (
      <Card {...args} className="max-w-md">
        ...
        />
        <Card.Body>
          <p className="text-body text-neutral-600 dark:text-neutral-300">{t.card.report.body}</p>
        </Card.Body>
        <Card.Footer>
          <span>
  ...
  render: () => {
    ...
    return (
      <Card variant="ai" className="max-w-md">
        ...
        />
        <Card.Body>
          <p className="text-body leading-relaxed text-neutral-700 dark:text-neutral-200">{t.card.ai.body}</p>
        </Card.Body>
        <Card.Footer>
  ...
  render: () => {
    ...
    return (
      <Card variant="outline" className="max-w-md">
        ...
        <Card.Body>
          <p className="text-body text-neutral-600 dark:text-neutral-300">{t.card.plan.body}</p>
        </Card.Body>
      </Card>
    );
  },
  ...
  render: () => {
    ...
    return (
      <Card variant="ghost" className="max-w-md">
        ...
        <Card.Body>
          <p className="text-body text-neutral-600 dark:text-neutral-300">{t.card.tip.body}</p>
        </Card.Body>
      </Card>
    );
  },
  ...
  render: () => {
    ...
    return (
      <Card className="max-w-md">
        ...
        <Card.Body>
          <p className="text-body text-neutral-600 dark:text-neutral-300">{t.card.section.body}</p>
        </Card.Body>
      </Card>
    );
  },
